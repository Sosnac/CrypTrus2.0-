...
Replace the default cert.pem with your organization's CA-signed certificates for production use. OR if you don't have any CA signed cert run the below command in your command to render a self-signed certificate for SSL/TLS Encryption.
```bash
pkg install openssl
